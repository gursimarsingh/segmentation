...
BODY_PARTS = {"Nose":0, "Neck":1, "RShoulder":2,  "RElbow":3, "RWrist":4,
                        "LShoulder":5,  "LElbow":6, "LWrist":7, "RHip":8, "RKnee":9,
                         "RAnkle":10, "LHip":11, "LKnee"    :12, "LAnkle":13, "REye":14,
                          "LEye":15, "REar":16, "LEar":17, "Bkg":18}
import os
import json
...
class GenerateMask:
     ...
     def produce_ma_mask(self, kp_array, img_size, point_radius=15):
        ...
        limbs = [[2,3], [2,6], [3,4], [4,5], [6,7], [7,8], [6,9], [9,10],
                  [10,11], [3,12], [12,13], [13,14], [2,1], [1,15], [15,17],
                   [1,16], [16,18], [2,17], [2,18], [9,12], [12,6], [9,3], [17,18],[2,12],[2,9]]
     ...
     def segmentation(self,pose_coord,(h,w)):
        ### sure foreground
        mask1=self.produce_ma_mask(pose_coord, (h, w),4)
        ...
        mask2=self.produce_ma_mask(pose_coord, (h, w),10)
